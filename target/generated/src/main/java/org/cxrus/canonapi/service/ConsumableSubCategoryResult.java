...
/**
 * <p>Java class for consumableSubCategoryResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="consumableSubCategoryResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="resultlist" type="{http://service.canonapi.cxrus.org/}consumableList" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "consumableSubCategoryResult", propOrder = {
    "description",
    "imageMedium",
    "name",
    "resultlist",
...
public class ConsumableSubCategoryResult {

    protected String description;
    protected String imageMedium;
    protected String name;
    @XmlElement(nillable = true)
    protected List<ConsumableList> resultlist;
     ...
     * 
     */
    public List<ConsumableList> getResultlist() {
        if (resultlist == null) {
            resultlist = new ArrayList<ConsumableList>();
        }
