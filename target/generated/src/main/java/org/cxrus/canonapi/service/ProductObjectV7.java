...
/**
 * <p>Java class for productObjectV7 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="productObjectV7">
 *   &lt;complexContent>
 ...
 *         &lt;element name="descIcon" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 ...
 *         &lt;element name="productQuickLink" type="{http://service.canonapi.cxrus.org/}productQuickLink" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "productObjectV7", propOrder = {
    "accessories",
    "accessoryContent",
    "accessoryTitle",
    "additionalBox",
...
public class ProductObjectV7 {
    ...
    @XmlElement(nillable = true)
    protected List<ProductQuickLink> productQuickLink;
    @XmlElement(nillable = true)
    ...
    /**
     * Gets the value of the descIcon property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the descIcon property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setDescIcon(String value) {
        this.descIcon = value;
    }
    ...
    /**
     * Gets the value of the productQuickLink property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the productQuickLink property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getProductQuickLink().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ProductQuickLink }
     * 
     * 
     */
    public List<ProductQuickLink> getProductQuickLink() {
        if (productQuickLink == null) {
            productQuickLink = new ArrayList<ProductQuickLink>();
        }
        return this.productQuickLink;
    }
