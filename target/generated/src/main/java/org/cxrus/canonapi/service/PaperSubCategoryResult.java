...
/**
 * <p>Java class for paperSubCategoryResult complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="paperSubCategoryResult">
 *   &lt;complexContent>
 ...
 *         &lt;element name="resultlist" type="{http://service.canonapi.cxrus.org/}paperList" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "paperSubCategoryResult", propOrder = {
    "description",
    "imageMedium",
    "name",
    "resultlist",
...
public class PaperSubCategoryResult {

    protected String description;
    protected String imageMedium;
    protected String name;
    @XmlElement(nillable = true)
    protected List<PaperList> resultlist;
     ...
     * 
     */
    public List<PaperList> getResultlist() {
        if (resultlist == null) {
            resultlist = new ArrayList<PaperList>();
        }
