...
/**
 * <p>Java class for subCategoryObjectV2 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="subCategoryObjectV2">
 *   &lt;complexContent>
 ...
 *         &lt;element name="subcategoryMicrosite" type="{http://service.canonapi.cxrus.org/}subCategoryMicrosite" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "subCategoryObjectV2", propOrder = {
    "bigBanners",
    "brandingDescription",
    "brandingImageUrl",
    "brandingTitle",
    ...
    "metaKeyWords",
    "smallBanners",
    "subcategoryMicrosite",
    "systemName"
})
public class SubCategoryObjectV2 {
    ...
    @XmlElement(nillable = true)
    protected List<SubCategoryMicrosite> subcategoryMicrosite;
    ...
    /**
     * Gets the value of the subcategoryMicrosite property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the subcategoryMicrosite property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSubcategoryMicrosite().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link SubCategoryMicrosite }
     * 
     * 
     */
    public List<SubCategoryMicrosite> getSubcategoryMicrosite() {
        if (subcategoryMicrosite == null) {
            subcategoryMicrosite = new ArrayList<SubCategoryMicrosite>();
        }
        return this.subcategoryMicrosite;
    }
